...
function createGoogleMapsLink(destination) {
    ...
    var directionQuery = "https://www.google.com/maps/dir/?api=1&origin=" + usrLctn.latitude +','+ usrLctn.longitude+ "&destination=" + replaceSpace(destination) + "&travelmode=driving";
